...
We can plot the results e.g. using the `plot_var()` function using:

```{r message=FALSE, warning=FALSE, results="hide", fig.width=6, fig.height=3}
# plot temperature
...
```{r fig.height=3, fig.width=6, message=FALSE, warning=FALSE, results="hide"}
# plot the variables
...
# plot the net. growth
image2D(net_growth, growth$time, growth$z, main = "net. growth", col = mycol(100))
```
