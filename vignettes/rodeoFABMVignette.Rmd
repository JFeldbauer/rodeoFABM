...
ods <- system.file("vignettes/vignetteData/examples/simple_alg.ods",
                   package = "rodeoFABM")
...
```{r eval=FALSE}
ods <- system.file("vignettes/vignetteData/examples/simple_alg_par.ods",
                   package = "rodeoFABM")
file.copy(from = ods, to = ".", recursive = TRUE)
...
```{r eval=FALSE}
ods <- system.file("vignettes/vignetteData/examples/simple_alg_par_sed.ods",
                   package = "rodeoFABM")
file.copy(from = ods, to = ".", recursive = TRUE)
...
```{r eval=FALSE}
ods <- system.file("vignettes/vignetteData/examples/simple_alg_O2.ods",
                   package = "rodeoFABM")
file.copy(from = ods, to = ".", recursive = TRUE)
# read in first simple model
...
```{r eval=FALSE}
ods <- system.file("vignettes/vignetteData/examples/simple_alg_O2_POM.ods",
                   package = "rodeoFABM")
file.copy(from = ods, to = ".", recursive = TRUE)
