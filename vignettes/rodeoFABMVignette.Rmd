...
name suggests it is heavily influenced by the `R` package [`rodeo`](https://github.com/dkneis/rodeo)
...
If the provided compilation functions do not work on your operating system instructions on how to include your newly created `FABM` model can be found in the `FABM` wiki: [github.com/fabm-model/fabm/wiki/Developing-a-new-biogeochemical-model](https://github.com/fabm-model/fabm/wiki/Developing-a-new-biogeochemical-model). Instructions on how to compile `GOTM-FABM` can be obtained from the `GOTM` homepage: [gotm.net/portfolio/software/](https://gotm.net/portfolio/software/).
