...
copy all necessary files to run GOTM. We use the same meteo and hypso files as in the [first example](#first_exmpl)
...
file.remove(c("gotm", "model_1.f90", "model_2.f90", "model_3.f90", "model_4.f90", 
              ...
              "simple_alg_O2.ods", "simple_alg_par.ods", "simple_alg_par.ods",
